    ...
    <div className="bg-gray-100 text-gray-800 py-10 px-4 md:px-20">
      <div className="max-w-4xl mx-auto bg-white p-6 md:p-10 shadow-md rounded-lg">
        ...
        <div className="space-y-4 text-sm leading-relaxed overflow-y-auto">
          ...
          <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://rjrinfinity.com/Services ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>

          <p><strong>Platform Ownership:</strong> The Platform is owned by REPOSITORY JUNCTURE RESOURCE INFINITY, a company incorporated under the Companies Act, 1956 with its registered office at BLOCK 2, Chunilal Apartment, Garia Station Road, Wonder VET,   Kolkata Garia ,Kolkata ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..</p>
...
The use of Platform and/or availing of our Services is subject to the following Terms of Use:</p>
          ...
          <p><strong>Modifications:</strong> Notwithstanding anything contained in these Terms of Use, the parties shall not be liable for any failure to perform an obligation under these Terms if performance is prevented or delayed by a force majeure event..
...
All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website</p>
          ...
          {/* <p><strong>Jurisdiction:</strong> Any disputes shall be subject to the exclusive jurisdiction of the courts in Kolkata, West Bengal, India.</p>

          <p><strong>Contact:</strong> For questions or concerns regarding these terms, please reach out to us via the contact information provided on our website.</p> */}
        </div>
      </div>
    </div>
  );
