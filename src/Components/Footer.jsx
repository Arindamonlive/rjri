...
This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://rjrinfinity.com/Services ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').

The Platform is owned by REPOSITORY JUNCTURE RESOURCE INFINITY, a company incorporated under the Companies Act, 1956 with its registered office at BLOCK 2, Chunilal Apartment, Garia Station Road, Wonder VET,   Kolkata Garia ,Kolkata ,India (hereinafter referred to as ?Platform Owner?, 'we', 'us', 'our')..
...
Insert Name of the Office: R J R Infinity

Designation: CEO

Insert Name and Address of the Company: R J R Infinity, Kolkata

Contact us: +919830410335/ +917308656861

Write us: info@rjrinfinity.com/rjriinfo@gmail.com
...
Cancellations will only be considered if the request is made 8 days of placing the order. However, cancellation requests may not be entertained if the orders have been communicated to such sellers / merchant(s) listed on the Platform and they have initiated the process of shipping them, or the product is out for delivery. In such an event, you may choose to reject the product at the doorstep. 

REPOSITORY JUNCTURE RESOURCE INFINITY does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good. 

In case of receipt of damaged or defective items, please report to our customer service team. The request would be entertained once the seller/ merchant listed on the Platform, has checked and determined the same at its own end. This should be reported within 8 days of receipt of products. In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within 8 days of receiving the product. The customer service team after looking into your complaint will take an appropriate decision. 
...
In case of any refunds approved by REPOSITORY JUNCTURE RESOURCE INFINITY, it will take 16 days for the refund to be processed to you.
`,
    "Contact Us": "Email us at info@rjrinfinity.com/rjriinfo@gmail.com or call +919830410335/ +917308656861"
};
            ...
            {activePolicy && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white text-black rounded-md shadow-xl max-w-lg w-full mx-4 p-6 relative">
                        ...
                        <h3 className="text-xl font-semibold mb-4">{activePolicy}</h3>
